    ...
    return (
        <div className="flex justify-center h-screen items-center ">
            <div className="mb-3 xl:w-96 ">
                ...
                {isFail && <div id="toast-danger" className="flex items-center p-4 mx-auto mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                    ...
                    <div className="ml-3 text-sm font-normal ">There is no user with such username.</div>
                </div>}
            </div>
        </div>
    );
